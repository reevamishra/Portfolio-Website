...
DDespite the vulnerability being patched, the issue of communicating the implications to users remains. With the response of `just recycle your keys`, we can only recommend abandoning Travis CI altogether and doing damage control in the aftermath of their ignorance.
